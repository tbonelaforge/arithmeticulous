...
public class Page4 extends Page implements FocusListener, ActionListener {
    private JLabel jLabel1;
    private JTextField jTextField1;
    private int textFieldWidth;


    public Page4(int textFieldWidth) {
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (jTextField1.getText().equals("11")) {
            System.out.println("CORRECT!!! (need to move to page 5)\n");
            forwardHandler.run();
        } else {
            System.out.println("INCORRECT!!! (need to move back to page3)\n");
